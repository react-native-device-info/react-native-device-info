...
| Total Disk Capacity        | `getTotalDiskCapacity()`           | `number` e.g. 68719476736                                                                     | Total storage in bytes                                                                                               |
| Free Disk Storage          | `getFreeDiskStorage()`             | `number` e.g. 1995018240                                                                      | Free storage in bytes (Android - showing free external storage only)                                                       |
