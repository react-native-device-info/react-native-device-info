...
| WebView User Agent                 | `getWebViewUserAgent()`                 | Mozilla/5.0 (Linux; Android 6.0.1; XT1562 Build/MPDS24.107-52-11; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/58.0.3029.83 Mobile Safari/537.36 | ANDROID ONLY - Returns same user agent as the one being used for RN's WebView component |
